...
EEOP is an enlarged external occipital protuberance. We can use the variable eop_size_mm to determine how many of our subjects are above the 10mm specifiation for EEOP.  
```{r}
posture_data %>%
